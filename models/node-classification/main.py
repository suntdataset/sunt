...
def run_model(model, 
    ...
    fpath_model =  f'../../outputs/classification/node/exp_ii/weights/{model_name}.pth'
    ...
    df_loss = pd.DataFrame({'Epochs': np.arange(1, epochs+1),
                            'loss': training_loss})
    fpath_loss =  f'../../outputs/classification/node/exp_ii/train_loss/loss_{model_name}.csv'
    ...
    fpath_pred = '../../outputs/classification/node/exp_ii/inferences/'
    ...
    fpath_metrics = '../../outputs/classification/node/exp_ii/metrics/'
...
def run_gcn(data, sufix=''):
    ...
    mn = f'gcn{sufix}'
    log.add(f'../../outputs/classification/node/exp_ii/{mn}.log')
    epcs=100
...
def cross_valition():
    ...
    fpath_metrcis = '../../outputs/classification/node/exp_ii/metrics/cross_validation.csv'
